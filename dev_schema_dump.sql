...
CREATE TABLE public.document_master (
    ...
    "createdAt" timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone NOT NULL,
    hashed_key character varying(64) DEFAULT concat(md5((random())::text), ('-'::text || (EXTRACT(epoch FROM now()))::text)) NOT NULL
);
...
--
-- Name: partner_products_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.partner_products_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.partner_products_id_seq OWNER TO postgres;

--
-- Name: partner_products_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.partner_products_id_seq OWNED BY public.partner_products.id;
...
--
-- Name: partner_products id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.partner_products ALTER COLUMN id SET DEFAULT nextval('public.partner_products_id_seq'::regclass);
...
--
-- Name: bank_accounts bank_accounts_account_number_key10; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bank_accounts
    ADD CONSTRAINT bank_accounts_account_number_key10 UNIQUE (account_number);


--
-- Name: bank_accounts bank_accounts_account_number_key11; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bank_accounts
    ADD CONSTRAINT bank_accounts_account_number_key11 UNIQUE (account_number);


--
-- Name: bank_accounts bank_accounts_account_number_key12; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bank_accounts
    ADD CONSTRAINT bank_accounts_account_number_key12 UNIQUE (account_number);


--
-- Name: bank_accounts bank_accounts_account_number_key13; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bank_accounts
    ADD CONSTRAINT bank_accounts_account_number_key13 UNIQUE (account_number);


--
-- Name: bank_accounts bank_accounts_account_number_key14; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bank_accounts
    ADD CONSTRAINT bank_accounts_account_number_key14 UNIQUE (account_number);


--
-- Name: bank_accounts bank_accounts_account_number_key2; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bank_accounts
    ADD CONSTRAINT bank_accounts_account_number_key2 UNIQUE (account_number);


--
-- Name: bank_accounts bank_accounts_account_number_key3; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bank_accounts
    ADD CONSTRAINT bank_accounts_account_number_key3 UNIQUE (account_number);


--
-- Name: bank_accounts bank_accounts_account_number_key4; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bank_accounts
    ADD CONSTRAINT bank_accounts_account_number_key4 UNIQUE (account_number);


--
-- Name: bank_accounts bank_accounts_account_number_key5; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bank_accounts
    ADD CONSTRAINT bank_accounts_account_number_key5 UNIQUE (account_number);


--
-- Name: bank_accounts bank_accounts_account_number_key6; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bank_accounts
    ADD CONSTRAINT bank_accounts_account_number_key6 UNIQUE (account_number);


--
-- Name: bank_accounts bank_accounts_account_number_key7; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bank_accounts
    ADD CONSTRAINT bank_accounts_account_number_key7 UNIQUE (account_number);


--
-- Name: bank_accounts bank_accounts_account_number_key8; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bank_accounts
    ADD CONSTRAINT bank_accounts_account_number_key8 UNIQUE (account_number);


--
-- Name: bank_accounts bank_accounts_account_number_key9; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bank_accounts
    ADD CONSTRAINT bank_accounts_account_number_key9 UNIQUE (account_number);
...
ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_order_id_key UNIQUE (partner_order_id);
...
--
-- Name: partners partners_api_key_key2; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.partners
    ADD CONSTRAINT partners_api_key_key2 UNIQUE (api_key);


--
-- Name: partners partners_api_key_key3; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.partners
    ADD CONSTRAINT partners_api_key_key3 UNIQUE (api_key);
...
--
-- Name: partners partners_email_key2; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.partners
    ADD CONSTRAINT partners_email_key2 UNIQUE (email);


--
-- Name: partners partners_email_key3; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.partners
    ADD CONSTRAINT partners_email_key3 UNIQUE (email);
...
--
-- Name: partners partners_hashed_key_key2; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.partners
    ADD CONSTRAINT partners_hashed_key_key2 UNIQUE (hashed_key);


--
-- Name: partners partners_hashed_key_key3; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.partners
    ADD CONSTRAINT partners_hashed_key_key3 UNIQUE (hashed_key);


--
-- Name: partners partners_hashed_key_key4; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.partners
    ADD CONSTRAINT partners_hashed_key_key4 UNIQUE (hashed_key);


--
-- Name: partners partners_hashed_key_key5; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.partners
    ADD CONSTRAINT partners_hashed_key_key5 UNIQUE (hashed_key);
...
--
-- Name: users users_hashed_key_key1; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users
    ADD CONSTRAINT users_hashed_key_key1 UNIQUE (hashed_key);
...
--
-- Name: vkycs_order_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX vkycs_order_id ON public.vkycs USING btree (order_id);


--
-- Name: document_type document_type_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.document_type
    ADD CONSTRAINT document_type_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: document_type document_type_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.document_type
    ADD CONSTRAINT document_type_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: esigns esigns_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.esigns
    ADD CONSTRAINT esigns_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: purposes purposes_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.purposes
    ADD CONSTRAINT purposes_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: purposes purposes_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.purposes
    ADD CONSTRAINT purposes_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: transaction_type transaction_type_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transaction_type
    ADD CONSTRAINT transaction_type_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: transaction_type transaction_type_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transaction_type
    ADD CONSTRAINT transaction_type_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: vkycs vkycs_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.vkycs
    ADD CONSTRAINT vkycs_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.partners(id);


--
-- Name: vkycs vkycs_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.vkycs
    ADD CONSTRAINT vkycs_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id);


--
-- Name: vkycs vkycs_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.vkycs
    ADD CONSTRAINT vkycs_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.partners(id);
