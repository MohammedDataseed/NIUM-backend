...
let EkycService = EkycService_1 = class EkycService {
    ...
    async sendEkycRequest(orderId) {
        ...
        try {
            ...
            await esign_model_1.ESign.create({
                ...
                esign_file_details: Object.assign(Object.assign({}, requestData.data.esign_file_details), { esign_file: "https://fibregridstorage.blr1.digitaloceanspaces.com/Fibregrid_projects/FY_25-26/NIUM/NIUM-NODE_NIU_25-26_01_[Ekfrazo]/stage 4/PDF Files/merged_1741857821406_part1.pdf" }),
    ...
    async handleEkycRetrieveWebhook(partner_order_id) {
        ...
        const orderData = await this.orderRepository.findOne({
            ...
            include: [
                { model: esign_model_1.ESign, as: "esigns" },
            ]
        });
        if (!orderData) {
