...
export class RoleController {
  ...
  // @ApiResponse({
  //   status: 200,
  //   description: "Merged PDF successfully created.",
  //   schema: {
  //     example: {
  //       message: "Merged PDF created successfully!",
  //       file_url: "/uploads/merged_1700000000000.pdf",
  //     },
  //   },
  // })
  // @ApiResponse({
  ...
  //   return this.storageService.uploadFile(file.buffer, file.originalname, body.path, body.role);
  // }
