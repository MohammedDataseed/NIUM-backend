...
export class CreatePartnerDto {
  ...
  @ApiProperty({ example: "large_enterprise", enum: business_type, description: "Business type" })
...
export class UpdatePartnerDto {
  ...
  @ApiPropertyOptional({ example: "large_enterprise", enum: business_type, description: "Business type" })
  @IsEnum(business_type)
  @IsOptional()
  business_type?: business_type;
...
export class PartnerResponseDto {
  @ApiProperty({ example: "a1b2c3d4e5f6...", description: "Unique hashed key for the partner" })
  hashed_key: string;
  ...
  @ApiProperty({ example: "apikey-12345", description: "API Key for authentication" })
  api_key: string;
  ...
  @ApiProperty({ example: "2025-03-08T12:00:00Z", description: "Creation timestamp" })
  created_at: Date;

  @ApiProperty({ example: "2025-03-08T12:00:00Z", description: "Last updated timestamp" })
  updated_at: Date;
