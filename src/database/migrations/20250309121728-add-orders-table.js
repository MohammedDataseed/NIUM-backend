// migrations/20250309-recreate-orders-table.js
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable('orders', {
      ...
      partner_id: {
        ...
        allowNull: false,
        references: {
          model: 'partners', // Adjust if your Partner table name differs
          key: 'id',
        },
        onUpdate: 'CASCADE',
        onDelete: 'RESTRICT',
      ...
      checker_id: {
        ...
        allowNull: false,
        references: {
          model: 'users', // Adjust if your User table name differs
          key: 'id',
        },
        onUpdate: 'CASCADE',
        onDelete: 'RESTRICT',
